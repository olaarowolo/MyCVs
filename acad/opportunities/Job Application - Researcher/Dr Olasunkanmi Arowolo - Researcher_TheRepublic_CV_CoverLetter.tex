...
\subsection*{Current Research}
    ...
    \resumeItem{Perceptions and Perspectives: Insights from East African Journalists on the Role of Artificial Intelligence in News Production}
        ...
        \resumeItem{``Reclaiming authenticity in Nigerian press: a study of a National Social Investment Programme''}
        \resumeItem{``The side-lined voice of the poor: slants and framing of poverty by the Nigerian print media''}
        \resumeItem{``'Voices of the oppressed': an analysis of Nigeria Twittersphere conversations on Tradermoni poverty programme in Nigeria''}
        \resumeItem{``What's up? News trading in the Nigerian press''}
        \resumeItem{``'Bottom-up news': do ordinary people matter in the news? -- a study of Tradermoni poverty programme in Nigeria''}
        \resumeItem{``Echoing the frames: Eyes on Nigerian print media accounts of Lekki Toll Gate Massacre''}
    \resumeItemListEnd
%-------------------------------------------
