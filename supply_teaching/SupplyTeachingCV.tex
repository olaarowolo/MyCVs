...
\section{Teaching and Cover Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Delivered engaging instruction in Health and Social Care to 76 students, with a focus on media communication relevant to the UK context, integrating practical insights from media and health sector experience}
        \resumeItem{Developed eight tailored lesson plans incorporating real-world media scenarios (e.g., audio-visual storytelling, communication ethics, media literacy)}
        ...
        \resumeItem{Collaborated with three colleagues to align media aspects of the programme with industry standards, equipping students with skills applicable to health and media sectors}
      \resumeItemListEnd
\newpage
    \resumeSubheading
      ...
      {Teacher Active}{UK}
      \resumeItemListStart
        \resumeItem{Ensured a secure learning environment for pupils across multiple subjects}
        \resumeItem{Conducted pre-established lessons with minimal preparation time}
        \resumeItem{Maintained pupil discipline and classroom management}
        \resumeItem{Collaborated effectively with fellow staff members}
        \resumeItem{Communicated professionally with pupils, staff, and parents}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Provided safe and secure learning environment for pupils across diverse subjects and age groups}
        \resumeItem{Delivered pre-planned lessons across multiple subjects with minimal preparation time}
        \resumeItem{Managed pupil behaviour effectively using positive reinforcement strategies}
        \resumeItem{Liaised with staff members and provided feedback to regular teachers}
        \resumeItem{Ensured health and safety of pupils and supported those with special educational needs and disabilities}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed and delivered teaching for the 15-credit Studying Journalism module (JOUR4050) to 23 undergraduate pupils per semester}
        \resumeItem{Created original teaching materials and learning support resources for 13 seminar groups}
        \resumeItem{Set and marked assignments with detailed feedback for pupil progress}
        \resumeItem{Acted as personal tutor providing pastoral care and mentoring}
        \resumeItem{Collaborated on curriculum development and attended subject group meetings}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Led seminar teaching for modules SOCI3370 and SOCI5750 for approximately 142 pupils}
        \resumeItem{Developed instructional materials and learning aids for diverse learning styles}
        \resumeItem{Evaluated pupil progress and provided feedback to approximately 56 pupils}
        \resumeItem{Demonstrated adaptability across different academic disciplines}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed appropriate teaching materials and supervised practical work for 950 undergraduate pupils}
        \resumeItem{Delivered instruction across multiple journalism modules with excellent pupil outcomes}
        ...
        \resumeItem{Contributed to research activities whilst maintaining high teaching standards}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
%-------------------------------------------
